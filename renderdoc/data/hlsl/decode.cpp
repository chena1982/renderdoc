...
#define FOURCC_RDEF FOURCC('R', 'D', 'E', 'F') //Resource definition (e.g. constant buffers)
#define FOURCC_ISGN FOURCC('I', 'S', 'G', 'N') //Input signature
#define FOURCC_IFCE FOURCC('I', 'F', 'C', 'E') //Interface (for dynamic linking)
#define FOURCC_OSGN FOURCC('O', 'S', 'G', 'N') //Output signature

#define FOURCC_ISG1 FOURCC('I', 'S', 'G', '1') //Input signature with Stream and MinPrecision
#define FOURCC_OSG1 FOURCC('O', 'S', 'G', '1') //Output signature with Stream and MinPrecision
